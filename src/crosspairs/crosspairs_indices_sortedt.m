function [iout, jout, status, dx, dy, dr, dt] = crosspairs_indices_sortedt(x1, y1, t1, x2, y2, t2, rmax,...
        taumin, maxtau)
...
[iout_after, jout_after, status] = Fcrosspairs_indices_sortedt(x1_s, y1_s, t1_s, x2_s, y2_s, t2_s, rmax, taumin, maxtau);
