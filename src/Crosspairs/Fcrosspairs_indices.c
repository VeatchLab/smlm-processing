...
void Fcrosspairs_indices(n1, x1, y1, t1, n2, x2, y2, t2, rmax, taumin, taumax,
        noutmax, nout, iout, jout, status)
     /* inputs */
     int n1, n2, noutmax;
     double *x1, *y1, *x2, *y2, *t1, *t2, rmax, taumin, taumax;
     /* outputs */
...
void mexFunction(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
    ...
    Fcrosspairs_indices(n1, x1, y1, t1, n2, x2, y2, t2,
