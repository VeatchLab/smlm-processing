...
void Fcrosspairs_indices_sortedt(n1, x1, y1, t1, n2, x2, y2, t2, rmax, taumin, taumax, noutmax, 
	      nout, iout, jout, 
	      status)
     /* inputs */
     int n1, n2, *noutmax;
     ...
     int *status;
{
  ...
  double x1i, y1i, t1i, r2max, tfirst, dx, dy, dx2, d2, dt;
    ...
    int nrhs, const mxArray* prhs[])
{
    ...
    *noutmax = noutmax_guess;
    ...
    Fcrosspairs_indices_sortedt(n1, x1, y1, t1, n2, x2, y2, t2, rmax, noutmax, taumin, taumax,
        nout, &iout, &jout,
        status);
